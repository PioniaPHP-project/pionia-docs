...
New projects are created with **`composer create-project pionia/pionia-app`** — see [Introduction](/documentation/getting-started/introduction/). The CLI commands below run **inside** an existing app directory.
...
Full tag reference, examples, and `/docs` setup: **[Documenting your API (Moonlight)](/documentation/building-api/api-reference/)**.
