...
See [HTTP routing](/documentation/http-routing/) for `CompiledRouteMatcher`, bootstrap route cache, and production `php pionia optimize --production`.
...
See [Production performance](/documentation/production-performance/).
...
Or from an existing Pionia install: `php pionia new my-api-v3 --install`.

See [Application structure](/documentation/application-structure/) for the full v3 tree.
