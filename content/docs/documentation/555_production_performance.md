...
`/stats` reports OPcache hit rate, preload memory, JIT status, and cached script counts. See [Developer stats](/documentation/developer-stats/).
...
- [RoadRunner](/documentation/roadrunner/) — worker OPcache wiring
- [CLI commands](/documentation/commands-pionia-cli/) — full command reference
