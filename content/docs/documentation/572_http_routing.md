...
See [API versioning in Moonlight](/moonlight/api-versioning-in-moonlight/) for when to add a version.
...
- [Requests & responses](/documentation/requests-and-responses/) — Moonlight envelopes and request data
- [Application structure](/documentation/application-structure/) — bootstrap layout
- [API versioning](/moonlight/api-versioning-in-moonlight/) — multiple switches
- [App providers](/documentation/extending/app-providers/) — package routes
- [Production performance](/documentation/production-performance/) — preload, bootstrap cache, OPcache
- [Upgrading from v2](/documentation/upgrading-from-v2/) — bootstrap migration
