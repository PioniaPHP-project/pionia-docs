...
- [Actions](/documentation/building-api/actions/) — action signatures and typed getters
- [Validations](/documentation/building-api/validation/) — `ValidationException` for bad input
- [Helpers](/documentation/extending/helpers/) — `arr()` for lightweight array helpers
