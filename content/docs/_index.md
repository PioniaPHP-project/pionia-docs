---
title: "Docs"
description: "Official Pionia v3 guides — install with Composer, build DeskFlow, ship to production."
...
seo:
  ...
  description: "Composer-first guides for Moonlight APIs, Porm, RoadRunner, and the DeskFlow tutorial."
  canonical: ""
  noindex: false
---
...
{{< card-grid >}}
{{< link-card title="Try the tutorial" description="Build DeskFlow hands-on — from ping to task.list." href="/documentation/deskflow-tutorial/" >}}
...
|---------|----------------|
| [Getting started](/documentation/getting-started/) | Composer install, PHP basics, DeskFlow tutorial, app layout |
| [Building your API](/documentation/building-api/) | Moonlight envelopes, services, actions, validation, generic CRUD |
| [Database (Porm)](/documentation/database/) | Queries, filters, joins, pagination on `tasks` and related tables |
| [HTTP & middleware](/documentation/http/) | Status codes, middleware chains, exceptions, routing |
| [Security](/documentation/security/) | JWT login, `mustAuthenticate()`, security utilities |
